...
extern unsigned int _system_initcall_begin;
extern unsigned int _system_initcall_end;
...
#define system_initcall(fn) __def_initcall(fn,0)
#define early_initcall(fn) __def_initcall(fn,1)
#define initcall(fn) __def_initcall(fn,2)
